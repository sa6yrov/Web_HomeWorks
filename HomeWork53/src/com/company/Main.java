...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 100; i++) {
            DaysOfWeek daysOfWeek = daysOfWeeks[rnd.nextInt(7)];
            int prevCount = daysOfWeekIntegerMap.getOrDefault(daysOfWeek, 0);
            daysOfWeekIntegerMap.put(daysOfWeek, ++prevCount);
        }
